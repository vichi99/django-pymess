...
.. function:: pymess.backend.emails.send_template(recipient, slug, context_data, locale=None, variant=None, related_objects=None, attachments=None, tag=None, send_immediately=False)
